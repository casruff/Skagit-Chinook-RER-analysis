...
\NormalTok{me_mean <-}\StringTok{ }\FloatTok{1.07}
\NormalTok{me_sd <-}\StringTok{ }\FloatTok{0.19}
...
\includegraphics{App_2_Summarize_results_Spring_Chinook_files/figure-latex/plot_RER_profile-1.pdf}
